...
1. [リリースページ](https://github.com/6EFB0D/ZipSearch/releases)から最新のDMGファイルをダウンロード
2. DMGファイルを開いてアプリケーションをアプリケーションフォルダにドラッグ
3. アプリケーションからZipSearchを起動

### Linux版（AppImage）

1. [リリースページ](https://github.com/6EFB0D/ZipSearch/releases)から最新のAppImageファイルをダウンロード
2. ファイルに実行権限を付与: `chmod +x ZipSearch-*.AppImage`
3. ダブルクリックまたはコマンドラインから実行: `./ZipSearch-*.AppImage`
